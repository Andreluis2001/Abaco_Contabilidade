...
function FormaRegistroManutencaoComputador({numero_de_patrimonio}: Props) {
    ...
    return (
        <>
            <form className="form" id="equipment-form" onSubmit={handleSubmit(submitToManutencaoComputadores)}>
...
export default FormaRegistroManutencaoComputador;